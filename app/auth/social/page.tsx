...
export default function SocialInitialSetupPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 md:p-8 bg-matte-canvas text-on-surface">
      {/* Progress Header */}
      <header className="w-full max-w-6xl mx-auto mb-10 flex items-center justify-between gap-8">
        ...
        <section className="bg-surface-container border border-hairline-border rounded-3xl p-8 md:p-12 flex flex-col justify-center">
          ...
          <form className="space-y-8" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 gap-3">
                <button
                  ...
                  className={`objective-opt group flex items-center gap-4 p-4 rounded-xl border transition-all text-left ${
                    selectedObjective === "agendar"
                ...
                >
                  <span
                    className={`material-symbols-outlined transition-colors ${
                      selectedObjective === "agendar" ? "text-primary" : "text-on-surface-variant group-hover:text-primary"
                    }`}
                  >
                    calendar_month
                  </span>
                ...
                >
                  <span
                    className={`material-symbols-outlined transition-colors ${
                      selectedObjective === "vacinas" ? "text-primary" : "text-on-surface-variant group-hover:text-primary"
                    }`}
                  >
                    vaccines
                  </span>
                ...
                >
                  <span
                    className={`material-symbols-outlined transition-colors ${
                      selectedObjective === "produtos" ? "text-primary" : "text-on-surface-variant group-hover:text-primary"
                    }`}
                  >
                    shopping_bag
                  </span>
              ...
              <div className="flex flex-wrap gap-3">
                {["1", "2", "3", "4", "5+"].map((num) => (
                  <button
                    ...
                    className={`pet-count-opt w-12 h-12 flex items-center justify-center rounded-xl border font-label-bold transition-all ${
                      petCount === num
            ...
            <div className="pt-4">
              ...
              >
                Próxima etapa <span className="material-symbols-outlined">arrow_forward</span>
              </button>
